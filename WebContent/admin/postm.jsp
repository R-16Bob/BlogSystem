...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">博文管理</h1>
            <form class="form-inline" role="form" method="post" action="../Postm">
            		<input type="hidden" name=opt value=query>
            		<input type=text name="title" placeholder="请输入要查询的博文主题">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${alluname[count]}</td>
                        <td><a class="btn btn-warning" href="../Postm?opt=delete&pid=${allplist[count].pid}" role="button" >删除</a></td>
                    </tr>
                    </c:forEach>
                    </c:if>
            </div>
